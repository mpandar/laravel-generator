...
class VueJsLayoutPublishCommand extends PublishBaseCommand
{
   ...
   */
    ...
    private function copyView()
    {
        ...
        $templatePath = config('infyom.laravel_generator.templates', 'vendor/infyomlabs/laravel-generator/templates/');
        ...
        foreach ($baseRequestCustomFiles as $stub => $php) {
            $sourceFile = base_path($templatePath . $stub);
        ...
        $sourceFile = base_path($templatePath . 'vuejs/js/gulpfile.js');
        $destinationFile = base_path() . '/gulpfile.js';
        $this->publishFile($sourceFile, $destinationFile, 'gulpfile.js');

        $sourceFile = base_path($templatePath . 'vuejs/js/package.json');
